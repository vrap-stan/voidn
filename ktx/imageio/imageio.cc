...
void declareImageioFormat(const std::string& formatname, ImageInput::Creator inputCreator,
                          const char** inputExtensions, ImageOutput::Creator outputCreator,
...
#define DECLAREPLUG_WO(name)                                                                \
    declareImageioFormat(nullptr, nullptr, #name, (ImageOutput::Creator)name##OutputCreate, \
