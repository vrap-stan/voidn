...
namespace ktx
{
    ...
    struct OptionsCreate
    {
        ...
        void init(cxxopts::Options &opts)
        {
            opts.add_options()(
                ...
                kWidth,
                "Base level width in pixels. Required with --raw. For non-raw, if not set,"
                ...
                kHeight,
                "Base level height in pixels. Required with --raw. For non-raw, if not"
                ...
                cxxopts::value<uint32_t>(), "[0-9]+")(
                kDepth, "Base level depth in pixels. If set the texture will be a 3D texture.",
                cxxopts::value<uint32_t>(),
                "[0-9]+")(kLayers, "Number of layers. If set the texture will be an array texture.",
                          cxxopts::value<uint32_t>(),
                          "[0-9]+")(kLevels, "Number of mip levels.", cxxopts::value<uint32_t>(),
                                    "[0-9]+")(kRuntimeMipmap, "Runtime mipmap generation mode.")(
                kGenerateMipmap,
                "Causes mipmaps to be generated during texture creation."
                ...
                " This option is mutually exclusive with --runtime-mipmap and cannot be used with UINT "
                "or 3D textures.")(
                kScale,
                "Scale images as they are loaded. Cannot be used with --raw. It enables use of"
                " the \'Generate Mipmap\' options to tune the resampler.",
                cxxopts::value<float>(), "<float>")(kEncode,
                                                    "Encode the created KTX file. Case insensitive."
                ...
                kInputSwizzle, "Pre-swizzle input channels.", cxxopts::value<std::string>(),
                "[rgba01]{4}")(
                kAssignTf,
                "Force the created texture to have the specified transfer function, ignoring"
                " the transfer function of the input file(s). Possible options match the "
                "khr_df_transfer_e"
                " enumerators without the KHR_DF_TRANSFER_ prefix. The KHR_DF_TRANSFER_ prefix is "
                "ignored"
                " if present. Case insensitive."
                "\nThe options are:"
                " linear | srgb | srgb_eotf | scrgb | scrgb_eotf | itu | itu_oetf | bt601 | bt601_oetf "
                "| bt709 | bt709_oetf |"
                " bt2020 | bt2020_oetf | smpte170m | smpte170m_oetf | smpte170m_eotf | ntsc | "
                "ntsc_eotf | slog | slog_oetf |"
                " slog2 | slog2_oetf | bt1886 | bt1886_eotf | hlg_oetf | hlg_eotf | pq_oetf | pg_eotf "
                "| dcip3 | dcip3_eotf |"
                " pal_oetf | pal625_eotf | st240 | st240_oetf | st240_eotf | acescc | acescc_oetf | "
                "acescct | acescct_oetf |"
                " abobergb | adobergb_eotf",
                cxxopts::value<std::string>(), "<tf>")(kAssignOetf, "Same as --assign-tf. Deprecated.",
                                                       cxxopts::value<std::string>(), "<tf>")(
                kAssignPrimaries,
                "Force the created texture to have the specified color primaries, ignoring"
                " the color primaries of the input file(s). Possible options match the "
                "khr_df_primaries_e"
                " enumerators without the KHR_DF_PRIMARIES_ prefix. The KHR_DF_PRIMARIES_ prefix is "
                "ignored"
                " if present. Case insensitive."
                "\nThe options are:"
                " none | bt709 | srgb | bt601_ebu | bt601_smpte | bt2020 | ciexyz | aces | acescc | "
                "ntsc1953 | pal525 | displayp3 | adobergb.",
                cxxopts::value<std::string>(), "<primaries>")(
                kAssignTexcoordOrigin,
                ...
                " is specified."
                "\nAbsent --convert-texcoord-origin, the effect of this option is to cause "
                "KTXorientation"
                " metadata indicating the specified origin to be written to the output file.",
                cxxopts::value<std::string>(), "<origin>")(
                kConvertTf,
                "Convert the input image(s) to the specified transfer function, if different"
                " from the transfer function of the input file(s). If both this and --assign-tf are "
                "specified,"
                " conversion will be performed from the assigned transfer function to the transfer "
                "function"
                ...
                "<tf>")(kConvertOetf, "Same as --convert-tf. Deprecated.",
                        cxxopts::value<std::string>(), "<tf>")(
                kConvertPrimaries,
                "Convert the image image(s) to the specified color primaries, if different"
                " from the color primaries of the input file(s) or the one specified by "
                "--assign-primaries."
                ...
                " Possible options match the khr_df_transfer_e enumerators without the "
                "KHR_DF_TRANSFER_ prefix."
                ...
                " KTXorientation metadata indicating the specified origin is written to the output "
                "file.",
                cxxopts::value<std::string>(), "<origin>")(
                kFailOnColorConversions,
                "Generates an error if any of the input images would need to be color converted.")(
                kWarnOnColorConversions,
                "Generates a warning if any of the input images are color converted.")(
                kNoWarnOnColorConversions,
                "Disable all warnings about color conversions including that for"
                " visually lossy conversions. Overrides --warn-on-color-conversions should both be "
                "specified.")(kFailOnOriginChanges,
                              "Generates an error if any of the input images would need to have their "
                              "origin changed.")(
                kWarnOnOriginChanges,
            ...
            opts.add_options("Generate Mipmap")(
                ...
                kMipmapFilterScale,
                "The filter scale to use. Defaults to 1.0. Ignored unless --generate-mipmap,"
                                                               ...
                                                               Reporter &report) const
        {
            ...
            else if (args[deprArgName].count())
            { // Prefer non-depcrecated name.
                report.warning(
                    "Option --{} is deprecated and will be removed in the next release. Use --{} "
                    "instead.",
                    deprArgName, argName);
            ...
            if (argNameToUse)
            {
                ...
                {
                    transferStr.erase(transferStr.begin(), transferStr.begin() + prefixStr.size());
                }
        ...
        std::optional<khr_df_primaries_e> parseColorPrimaries(cxxopts::ParseResult &args,
                                                              const char *argName,
                                                              Reporter &report) const
        {
            ...
            if (args[argName].count())
            {
                ...
                {
                    primariesStr.erase(primariesStr.begin(), primariesStr.begin() + prefixStr.size());
                }
                ...
                {
                    report.fatal_usage(
                        "Invalid or unsupported primaries specified as --{} argument: \"{}\".", argName,
        ...
        std::optional<ImageSpec::Origin> parseTexcoordOrigin(cxxopts::ParseResult &args,
                                                             ...
                                                             Reporter &report) const
        {
            ...
            if (args[argName].count())
            {
                ...
                // std::regex
                // re(R"--((?:\b(top|bottom)\b-)?(?:\b(left|right)\b)(?:-\b(front|back)\b)?)--");
                ...
                {
                    report.fatal_usage(
                        "Invalid or unsupported origin specified as --{} argument: \"{}\".", argName,
                        originStr);
                }
                if (numDimensions == 3 && sm.str(3).empty())
                {
                    report.fatal_usage("Z origin must be specified in --{} argument for a 3D texture.",
                                       argName);
                }
                ...
                orig.x =
                    sm.str(2).compare("left") ? ImageSpec::Origin::eRight : ImageSpec::Origin::eLeft;
                orig.y =
                    sm.str(1).compare("bottom") ? ImageSpec::Origin::eTop : ImageSpec::Origin::eBottom;
        ...
        void process(cxxopts::Options &, cxxopts::ParseResult &args, Reporter &report)
        {
            ...
            if (args[kMipmapFilter].count())
            {
                ...
                if (filter_table.count(*mipmapFilter) == 0)
                    report.fatal_usage(
                        "Invalid or unsupported mipmap filter specified as --mipmap-filter argument: "
                        "\"{}\".",
                        *mipmapFilter);
            }
            ...
            if (args[kMipmapWrap].count())
            {
                ...
                if (it == wrap_table.end())
                    report.fatal_usage(
                        "Invalid or unsupported mipmap wrap mode specified as --mipmap-wrap argument: "
                        "\"{}\".",
                        wrapStr);
                else
            ...
            if (args[kSwizzle].count())
            {
                ...
                const auto errorFmt =
                    "Invalid --swizzle value: \"{}\". The value must match the \"[rgba01]{{4}}\" "
                    "regex.";
                if (swizzle->size() != 4)
            ...
            if (args[kInputSwizzle].count())
            {
                ...
                const auto errorFmt =
                    "Invalid --input-swizzle value: \"{}\". The value must match the \"[rgba01]{{4}}\" "
                    "regex.";
            ...
            if (args[kDepth].count())
                ...
                numDimensions = 1;
            assignTexcoordOrigin =
                parseTexcoordOrigin(args, numDimensions, kAssignTexcoordOrigin, report);
            convertTexcoordOrigin =
                parseTexcoordOrigin(args, numDimensions, kConvertTexcoordOrigin, report);
            ...
            if (args[kFormat].count())
            {
                ...
                if (!parsedVkFormat)
                    report.fatal_usage("The requested format is invalid or unsupported: \"{}\".",
                                       formatStr);
            ...
            if (isProhibitedFormat(vkFormat))
                report.fatal_usage("The requested {} format is prohibited in KTX files.",
                                   toString(vkFormat));
            ...
            if (raw)
            {
                if (!width)
                    report.fatal_usage(
                        "Option --width is missing but is required for --raw texture creation.");
                if (!height)
                    report.fatal_usage(
                        "Option --height is missing but is required for --raw texture creation.");
            }
            ...
            if (raw)
            {
                const auto maxDimension =
                    std::max(width.value_or(1), std::max(height.value_or(1), depth.value_or(1)));
                const auto maxLevels = log2(maxDimension) + 1;

                if (levels.value_or(1) > maxLevels)
                    report.fatal_usage(
                        "Requested {} levels is too many. With base size {}x{}x{} the texture can only "
                        "have {} levels at most.",
                        levels.value_or(1), width.value_or(1), height.value_or(1), depth.value_or(1),
                        maxLevels);
            }
            ...
            if (layers && depth)
                report.fatal_usage(
                    "3D array texture creation is unsupported. --layers is {} and --depth is {}.",
                    *layers, *depth);
            ...
            if (mipmapRuntime && levels.value_or(1) > 1u)
                report.fatal_usage(
                    "Conflicting options: --runtime-mipmap cannot be used with more than 1 --levels.");

            if (mipmapGenerate && mipmapRuntime)
                report.fatal_usage(
                    "Conflicting options: --generate-mipmap and --runtime-mipmap cannot be used "
                    "together.");
            ...
            if (mipmapGenerate && depth)
                report.fatal_usage(
                    "Mipmap generation for 3D textures is not supported: --generate-mipmap cannot be "
                    "used with --depth.");
            ...
            if (raw)
            {
                ...
                if (convertTexcoordOrigin.has_value())
                    report.fatal_usage("Option {} cannot be used with --{}.", kConvertTexcoordOrigin,
                                       kRaw);
            ...
            if (formatDesc.transfer() == KHR_DF_TRANSFER_SRGB)
            {
                const auto error_message =
                    "Invalid value \"{}\" to --{} for format \"{}\". Transfer function must be sRGB "
                    "for sRGB formats.";
                if (!convertTF.has_value() && assignTF.has_value())
                {
                    ...
                    case KHR_DF_TRANSFER_SRGB:
                        ...
                        break;
                    default:
                        report.fatal_usage(error_message,
                                           args[kAssignTf].count()
                                               ? args[kAssignTf].as<std::string>()
                                               : args[kAssignOetf].as<std::string>(),
                ...
                {
                    report.fatal_usage(error_message,
                                       args[kConvertTf].count() ? args[kConvertTf].as<std::string>()
                                                                : args[kConvertOetf].as<std::string>(),
            ...
            {
                const auto error_message =
                    "Invalid value \"{}\" to --{} for format \"{}\". Transfer function must not be "
                    "sRGB for a non-sRGB VkFormat with sRGB variant.";
                if (!convertTF.has_value() && assignTF.has_value() &&
                    assignTF == KHR_DF_TRANSFER_SRGB)
                {
                    report.fatal_usage(error_message,
                                       args[kAssignTf].count() ? args[kAssignTf].as<std::string>()
                                                               : args[kAssignOetf].as<std::string>(),
                                       kAssignTf, args[kFormat].as<std::string>());
                }
                else if (convertTF.has_value() && convertTF == KHR_DF_TRANSFER_SRGB)
    ...
    */
    ...
    {
    private:
        Combine<OptionsCreate, OptionsEncodeASTC, OptionsEncodeBasis<false>, OptionsEncodeCommon,
                OptionsMetrics, OptionsDeflate, OptionsMultiInSingleOut, OptionsGeneric>
            options;
    ...
    private:
        ...
        void generateMipLevels(KTXTexture2 &texture, std::unique_ptr<Image> image,
                               ImageInput &inputFile, uint32_t numMipLevels, uint32_t layerIndex,
                               uint32_t faceIndex, uint32_t depthSliceIndex);
        std::unique_ptr<Image> scaleImage(std::unique_ptr<Image> image, uint32_t width,
                                          uint32_t height);
        ...
        void determineTargetColorSpace(const ImageInput &in, ImageSpec &target,
                                       ColorSpaceInfo &colorSpaceInfo);
        void determineSourceOrigin(const ImageInput &in, ImageSpec::Origin &usedSourceOrigin);
        void determineTargetOrigin(const ImageInput &in, ImageSpec &target,
    ...
    void CommandCreate::initOptions(cxxopts::Options &opts) { options.init(opts); }

    void CommandCreate::checkNumInputImages()
    {
        const auto blockSizeZ =
            isFormat3DBlockCompressed(options.vkFormat)
                ? createFormatDescriptor(options.vkFormat, *this).basic.texelBlockDimension2 + 1u
                : 1u;
        ...
        for (uint32_t i = 0; i < (options.mipmapGenerate ? 1 : options.levels.value_or(1)); ++i)
            ...
            expectedInputImages +=
                numLayers * numFaces * ceil_div(std::max(baseDepth >> i, 1u), blockSizeZ);
        if (options.inputFilepaths.size() != expectedInputImages)
        {
            fatal_usage(
                "Too {} input images for {} level{}, {} layer, {} face and {} depth. Provided {} but "
                "expected {}.",
                options.inputFilepaths.size() > expectedInputImages ? "many" : "few", numLevels,
                options.mipmapGenerate ? " (mips generated)" : "", numLayers, numFaces, baseDepth,
    ...
    void CommandCreate::processOptions(cxxopts::Options &opts, cxxopts::ParseResult &args)
    {
        ...
        if (options.codec != BasisCodec::NONE)
        {
            ...
            default:
                fatal_usage(
                    ...
                    "but format is {}.",
                    toString(VkFormat(options.vkFormat)));
                break;
            }
        }
        ...
        if (isFormatAstc(options.vkFormat) && !options.raw)
        {
            ...
            case VK_FORMAT_ASTC_12x12_SRGB_BLOCK:
                ...
                break;
            default:
                fatal(rc::NOT_SUPPORTED, "{} is unsupported for ASTC encoding.",
    ...
    void CommandCreate::foreachImage(const FormatDescriptor &format, F &&func)
    {
        ...
        for (uint32_t levelIndex = 0; levelIndex < (options.mipmapGenerate ? 1 : numLevels);
             ++levelIndex)
        {
            const auto numDepthSlices =
                ceil_div(std::max(baseDepth >> levelIndex, 1u), format.basic.texelBlockDimension2 + 1u);
            for (uint32_t layerIndex = 0; layerIndex < numLayers; ++layerIndex)
            {
                for (uint32_t faceIndex = 0; faceIndex < numFaces; ++faceIndex)
                {
                    for (uint32_t depthSliceIndex = 0; depthSliceIndex < numDepthSlices;
                         ++depthSliceIndex)
                    {
                        assert(inputFileIt != options.inputFilepaths.end() &&
                               "Internal error"); // inputFilepaths size was already validated during
                                                  // arg parsing
        ...
        assert(inputFileIt == options.inputFilepaths.end() &&
               "Internal error"); // inputFilepaths size was already validated during arg parsing
    }
    ...
    std::string CommandCreate::readRawFile(const std::filesystem::path &filepath)
    {
        ...
        if (inputStream->fail())
            fatal(rc::IO_FAILURE, "Failed to seek file \"{}\": {}.", filepath.generic_string(),
                  errnoMessage());
        ...
        if (inputStream->fail())
            fatal(rc::IO_FAILURE, "Failed to read file \"{}\": {}.", filepath.generic_string(),
                  errnoMessage());
    ...
    {
        const auto warningFn = [this](const std::string &w)
        { this->warning(w); };
        ...
        foreachImage(options.formatDesc, [&](const auto &inputFilepath, uint32_t levelIndex,
                                             uint32_t layerIndex, uint32_t faceIndex,
                                             uint32_t depthSliceIndex)
                     {
        if (options.raw) {
            if (std::exchange(firstImage, false)) {
                target = ImageSpec{options.width.value_or(1u), options.height.value_or(1u),
                                   options.depth.value_or(1u), options.formatDesc};

                if (options.cubemap && target.width() != target.height())
                    fatal(rc::INVALID_FILE,
                          "--cubemap specified but the input image \"{}\" with size {}x{} is not "
                          "square.",
            ...
            if (rawData.size() != expectedFileSize)
                fatal(rc::INVALID_FILE,
                      "Raw input file \"{}\" with {} bytes for level {} does not match the "
                      "expected size of {} bytes.",
                      fmtInFile(inputFilepath), rawData.size(), levelIndex, expectedFileSize);

            const auto ret = ktxTexture_SetImageFromMemory(
                texture, levelIndex, layerIndex,
                faceIndex + depthSliceIndex,  // Faces and Depths are mutually exclusive, Addition
                                              // is acceptable
                reinterpret_cast<const ktx_uint8_t*>(rawData.data()), rawData.size());
            assert(ret == KTX_SUCCESS && "Internal error");
            (void)ret;
        } else {
            const auto inputImageFile = ImageInput::open(inputFilepath, nullptr, warningFn);
            inputImageFile->seekSubimage(
                0, 0);  // Loading multiple subimage from the same input is not supported
            ...
            if (std::exchange(firstImage, false)) {
                ...
                target = ImageSpec{targetWidth, targetHeight, options.depth.value_or(1u),
                                   options.formatDesc};
                ...
                if (options._1d && target.height() != 1)
                    fatal(rc::INVALID_FILE,
                          "For --1d textures the input image height must be 1, but for \"{}\" it "
                          "was {}.",
                          fmtInFile(inputFilepath), target.height());

                const auto maxDimension =
                    std::max(target.width(), std::max(target.height(), baseDepth));
                maxLevels = log2(maxDimension) + 1;
                if (options.levels.value_or(1) > maxLevels) {
                    auto errorFmt =
                        "Requested {} levels is too many. With {} {}x{} and depth {} the texture "
                        "can only have {} levels at most.";
                    std::string baseExpl;
                    if (options.width.has_value() || options.height.has_value()) {
                        ...
                        baseExpl = fmt::format(
                            ...
                            inputImageFile->spec().height(), options.imageScale.value());
                    } else {
                        baseExpl =
                            fmt::format("base input image \"{}\" sized", fmtInFile(inputFilepath));
                    }
                    fatal_usage(errorFmt, options.levels.value_or(1), baseExpl, target.width(),
                                target.height(), baseDepth, maxLevels);
                }
            ...
            const uint32_t expectedImageHeight =
                std::max(firstImageSpec.height() >> levelIndex, 1u);
            ...
            if (inputImageFile->spec().width() != expectedImageWidth ||
                inputImageFile->spec().height() != expectedImageHeight) {
                const auto errorFmt =
                    "Input image \"{}\" with size {}x{} does not match expected size {}x{} for "
                    "level {}.";
                fatal(rc::INVALID_FILE, errorFmt, fmtInFile(inputFilepath),
                      inputImageFile->spec().width(), inputImageFile->spec().height(),
                      // When no scaling option is specified image* == targetImage*.
                      expectedImageWidth, expectedImageHeight, levelIndex);
            }
            ...
            if (target.format().transfer() != colorSpaceInfo.src.usedTransferFunction ||
                ...
                if (colorSpaceInfo.src.transferFunction == nullptr) {
                    ...
                    auto errorMsg =
                        fmt::format(errorFmt, "decode from",
                                    toString(colorSpaceInfo.src.usedTransferFunction), source);
                    if (!options.assignTF.has_value()) {
                        errorMsg += fmt::format(
                            " Use an image processing tool to convert it or use"
                ...
                if (colorSpaceInfo.dst.transferFunction == nullptr) {
                    ...
                    auto source = fmt::format("specified with --{}", options.convertTF.has_value()
                                                                         ? options.kConvertTf
                                                                         : options.kAssignTf);
                    auto errorMsg = fmt::format(errorFmt, "encode to",
                                                toString(target.format().transfer()), source);
                    // Transfer functions derived from --format values are supported.
                    if (target.format().primaries() != colorSpaceInfo.src.usedPrimaries) {
                        errorMsg += fmt::format(
                            " Decode and encode with transfer function is"
                    ...
                    if (target.format().model() == KHR_DF_MODEL_RGBSDA &&
                        ...
                        if (bitLength < 14) {
                            ...
                            if (colorSpaceInfo.src.usedTransferFunction == KHR_DF_TRANSFER_SRGB ||
                                ...
                                warning(
                                    "Input file \"{}\" is undergoing a visual lossy color "
                                    "conversion from {} "
                                    "to KHR_DF_TRANSFER_LINEAR. Specify an _SRGB format with --{} "
                                    "to prevent "
                                    "this warning.",
                ...
                if (target.format().primaries() != colorSpaceInfo.src.usedPrimaries) {
                    ...
                    auto primaryTransform = colorSpaceInfo.src.colorPrimaries->transformTo(
                        *colorSpaceInfo.dst.colorPrimaries);

                    if (options.failOnColorConversions)
                        fatal(rc::INVALID_FILE,
                              "Input file \"{}\" would need color conversion as input and output "
                              "primaries are different. "
                              "Use --assign-primaries and do not use --convert-primaries to avoid "
                              "unwanted color conversions.",
                              fmtInFile(inputFilepath));

                    if (options.warnOnColorConversions)
                        warning(
                            "Input file \"{}\" is color converted as input and output primaries "
                            "are different. "
                            "Use --assign-primaries and do not use --convert-primaries to avoid "
                            "unwanted color conversions.",
                            fmtInFile(inputFilepath));
                    ...
                    image->transformColorSpace(*colorSpaceInfo.src.transferFunction,
                                               *colorSpaceInfo.dst.transferFunction,
                                               &primaryTransform);
                } else {
                    if (options.failOnColorConversions)
                        fatal(rc::INVALID_FILE,
                              "Input file \"{}\" would need color conversion as input and output "
                              "transfer functions are different. "
                              "Use --assign-tf and do not use --convert-tf to avoid unwanted color "
                              "conversions.",
                              fmtInFile(inputFilepath));

                    if (options.warnOnColorConversions)
                        warning(
                            "Input file \"{}\" is color converted as input and output transfer "
            ...
            if (target.origin() != usedSourceOrigin) {
                if (options.failOnOriginChanges)
                    fatal(rc::INVALID_FILE,
                          "Input file \"{}\" would need to be y-flipped as input and output "
                ...
                if (options.warnOnOriginChanges)
                    warning(
                        "Input file \"{}\" is y-flipped as input and output origins are different. "
                        "Use --{} and do not use --{} to avoid unwanted origin conversions.",
                        fmtInFile(inputFilepath), OptionsCreate::kAssignTexcoordOrigin,
                        OptionsCreate::kConvertTexcoordOrigin);
            ...
            if (options.normalize) {
                if (target.format().transfer() != KHR_DF_TRANSFER_UNSPECIFIED &&
                    ...
                    // const auto input_error_message = "Input file \"{}\" The transfer function to
                    // be applied to the created texture is neither linear nor none. Normalize is
                    // only available for these transfer functions."; const auto inputTransfer =
                    // inputImageFile->spec().format().transfer(); bool is_file_error =
                    // (inputTransfer != KHR_DF_TRANSFER_UNSPECIFIED && inputTransfer !=
                    // KHR_DF_TRANSFER_LINEAR);
                    const auto option_error_message =
                        "--{} value is {}. Normalize can only be used if the transfer function is "
                        "linear or none.";
                    ...
                    assert(false &&
                           "target.format().transfer() is not suitable for --normalize though "
                           "--assign-tf and --conver-tf were not used.");
                }
                image->normalize();
            }

            if (options.swizzleInput) image->swizzle(*options.swizzleInput);
            ...
            if (options.mipmapGenerate) {
                ...
                generateMipLevels(texture, std::move(image), *inputImageFile, numMipLevels,
                                  layerIndex, faceIndex, depthSliceIndex);
            }
        } });
        ...
        if (options.swizzle)
        {
            ktxHashList_AddKVPair(
                &texture->kvDataHead, KTX_SWIZZLE_KEY,
        ...
        // Add KTXwriterScParams metadata if ASTC encoding, BasisU encoding, or other supercompression
        // was used
        const auto writerScParams = fmt::format("{}{}{}{}", options.astcOptions, options.codecOptions,
    ...
    void CommandCreate::encodeASTC(KTXTexture2 &texture, OptionsEncodeASTC &opts)
    {
        ...
        if (ret != KTX_SUCCESS)
            fatal(rc::KTX_FAILURE, "Failed to encode KTX2 file with codec ASTC. KTX Error: {}",
                  ktxErrorString(ret));
    }
    ...
    std::unique_ptr<Image> CommandCreate::loadInputImage(ImageInput &inputImageFile)
    {
        ...
        inputImageFile.readImage(static_cast<uint8_t *>(*image), image->getByteCount(), 0, 0,
                                 loadFormat);
        return image;
    }

    std::vector<uint8_t> convertUNORMPacked(const std::unique_ptr<Image> &image, uint32_t C0,
    ...
    template <typename T>
    std::vector<uint8_t> convertUNORM(const std::unique_ptr<Image> &image,
                                      std::string_view swizzle = "")
    {
    ...
    template <typename T>
    std::vector<uint8_t> convertUNORMSBits(const std::unique_ptr<Image> &image, uint32_t sBits,
                                           std::string_view swizzle = "")
    {
        using ComponentT = typename T::Color::value_type;
        static constexpr auto componentCount = T::Color::getComponentCount();
    ...
    template <typename T>
    std::vector<uint8_t> convertSFLOAT(const std::unique_ptr<Image> &image,
                                       std::string_view swizzle = "")
    {
        using ComponentT = typename T::Color::value_type;
        static constexpr auto componentCount = T::Color::getComponentCount();
    ...
    template <typename T>
    std::vector<uint8_t> convertUINT(const std::unique_ptr<Image> &image,
                                     std::string_view swizzle = "")
    {
        using ComponentT = typename T::Color::value_type;
        static constexpr auto componentCount = T::Color::getComponentCount();
    ...
    std::vector<uint8_t> convertUINTPacked(const std::unique_ptr<Image> &image, uint32_t c0 = 0,
    ...
    std::vector<uint8_t> convertSINTPacked(const std::unique_ptr<Image> &image, uint32_t c0 = 0,
                                           uint32_t c1 = 0, uint32_t c2 = 0, uint32_t c3 = 0,
                                           std::string_view swizzle = "")
    {
        if (!swizzle.empty())
    ...
    template <typename T>
    std::vector<uint8_t> convertSINT(const std::unique_ptr<Image> &image,
                                     std::string_view swizzle = "")
    {
        using ComponentT = typename T::Color::value_type;
        static constexpr auto componentCount = T::Color::getComponentCount();
    ...
    std::vector<uint8_t> CommandCreate::convert(const std::unique_ptr<Image> &image, VkFormat vkFormat,
                                                ImageInput &inputFile)
    {
        const uint32_t inputBitDepth =
            std::max(8u, inputFile.spec().format().largestChannelBitLength());

        const auto require = [&](uint32_t bitDepth)
        {
            if (inputBitDepth < bitDepth)
                fatal(rc::INVALID_FILE,
                      "{}: Not enough precision to convert {} bit input to {} bit output for {}.",
                      inputFile.filename(), inputBitDepth, bitDepth, toString(vkFormat));
            if (inputBitDepth > imageio::bit_ceil(bitDepth))
                warning(
                    "{}: Possible loss of precision with converting {} bit input to {} bit output for "
                    "{}.",
                    inputFile.filename(), inputBitDepth, bitDepth, toString(vkFormat));
        };
        const auto requireUNORM = [&](uint32_t bitDepth)
        {
            ...
            case ImageInputFormatType::exr_float:
                fatal(rc::INVALID_FILE,
                      "{}: Input file data type \"{}\" does not match the expected input data type of "
                      "{} bit \"{}\" for {}.",
                      inputFile.filename(), toString(inputFile.formatType()), bitDepth, "UNORM",
                      toString(vkFormat));
            }
            require(bitDepth);
        };
        const auto requireSFloat = [&](uint32_t bitDepth)
        {
            ...
            case ImageInputFormatType::exr_uint:
                fatal(rc::INVALID_FILE,
                      "{}: Input file data type \"{}\" does not match the expected input data type of "
                      "{} bit \"{}\" for {}.",
                      inputFile.filename(), toString(inputFile.formatType()), bitDepth, "SFLOAT",
                      toString(vkFormat));
            }
            require(bitDepth);
        };
        const auto requireUINT = [&](uint32_t bitDepth)
        {
            ...
            case ImageInputFormatType::exr_float:
                fatal(rc::INVALID_FILE,
                      "{}: Input file data type \"{}\" does not match the expected input data type of "
                      "{} bit \"{}\" for {}.",
                      inputFile.filename(), toString(inputFile.formatType()), bitDepth, "UINT",
                      toString(vkFormat));
            }
            require(bitDepth);
        };
        ...
        case VK_FORMAT_B16G16R16G16_422_UNORM:
            fatal(rc::INVALID_ARGUMENTS, "Unsupported format for non-raw create: {}.",
                  toString(options.vkFormat));
            break;
        ...
        default:
            fatal(rc::INVALID_ARGUMENTS, "Requested format conversion is not yet implemented for: {}.",
                  toString(options.vkFormat));
        }
    ...
    KTXTexture2 CommandCreate::createTexture(const ImageSpec &target)
    {
        ...
        else
        {
            ...
            {
                const auto maxDimension =
                    std::max(target.width(), std::max(target.height(), target.depth()));
                const auto maxLevels = log2(maxDimension) + 1;
        ...
        if (KTX_SUCCESS != ret)
            fatal(rc::KTX_FAILURE, "Failed to create ktxTexture: libktx error: {}",
                  ktxErrorString(ret));
        ...
        if (options.assignTexcoordOrigin.has_value() || options.convertTexcoordOrigin.has_value())
        {
            ...
            ktxHashList_AddKVPair(
                &texture->kvDataHead, KTX_ORIENTATION_KEY,
    ...
    std::unique_ptr<Image> CommandCreate::scaleImage(std::unique_ptr<Image> image, ktx_uint32_t width,
                                                     ktx_uint32_t height)
    {
        try
        {
            image = image->resample(
                width, height, options.mipmapFilter.value_or(options.defaultMipmapFilter).c_str(),
    ...
    void CommandCreate::generateMipLevels(KTXTexture2 &texture, std::unique_ptr<Image> image,
                                          ...
                                          uint32_t depthSliceIndex)
    {
        ...
        for (uint32_t mipLevelIndex = 1; mipLevelIndex < numMipLevels; ++mipLevelIndex)
        {
            ...
            const auto ret = ktxTexture_SetImageFromMemory(
                texture, mipLevelIndex, layerIndex,
                faceIndex +
    ...
    void CommandCreate::selectASTCMode(uint32_t bitLength)
    {
        if (options.mode == KTX_PACK_ASTC_ENCODER_MODE_DEFAULT)
        {
            ...
            options.mode =
                bitLength <= 8 ? KTX_PACK_ASTC_ENCODER_MODE_LDR : KTX_PACK_ASTC_ENCODER_MODE_HDR;
        }
        else
        {
            if (bitLength > 8 && options.mode == KTX_PACK_ASTC_ENCODER_MODE_LDR)
                ...
                warning(
                    "Input file is 16-bit but ASTC LDR option is specified. Expect quality loss in the "
                    "output.");
    ...
    std::unique_ptr<const ColorPrimaries> CommandCreate::createColorPrimaries(
    ...
    void CommandCreate::determineSourceColorSpace(const ImageInput &in,
                                                  SrcColorSpaceInfo &srcColorSpaceInfo)
    {
        ...
        if (options.convertPrimaries.has_value())
        {
            if (srcColorSpaceInfo.usedPrimaries == KHR_DF_PRIMARIES_UNSPECIFIED)
            {
                fatal(rc::INVALID_FILE,
                      ...
                      in.filename(), options.kAssignPrimaries);
            }
            else if (options.convertPrimaries.value() != srcColorSpaceInfo.usedPrimaries)
            {
                srcColorSpaceInfo.colorPrimaries =
                    createColorPrimaries(srcColorSpaceInfo.usedPrimaries);
            }
        }
        ...
        else
        {
            ...
            if (spec.format().transfer() == KHR_DF_TRANSFER_UNSPECIFIED)
            {
                ...
                {
                    fatal(rc::INVALID_FILE,
                          "Input file \"{}\" contains unsupported ICC profile \"{}\". Use --{} to "
                          "specify a different one.",
                          in.filename(), spec.format().iccProfileName(), options.kAssignTf);
                }
                else if (spec.format().oeGamma() > 0.0f)
                {
                    if (spec.format().oeGamma() > .45450f && spec.format().oeGamma() < .45460f)
                    {
                        ...
                        warning(
                            "Converting gamma 2.2f to sRGB. Use --{} srgb to force treating input as "
                            "sRGB.",
                            options.kAssignTf);
                        srcColorSpaceInfo.transferFunction =
                            std::make_unique<TransferFunctionGamma>(spec.format().oeGamma());
                    }
                    ...
                    else if (spec.format().oeGamma() == 0.0f)
                    {
                        if (!in.formatName().compare("png"))
                        {
                            ...
                            warning(
                                "Ignoring reported gamma of 0.0f in {}-bit PNG input file \"{}\". "
                                "Handling as {}.",
                        ...
                        {
                            fatal(rc::INVALID_FILE,
                                  "Input file \"{}\" has gamma 0.0f. Use --{} to specify transfer "
                                  "function.",
                                  options.kAssignTf);
                        }
                    }
                    else
                    {
                        ...
                        {
                            fatal(rc::INVALID_FILE,
                                  "Gamma {} not automatically supported by KTX. Specify handing with "
                                  "--{} or --{}.",
                                  spec.format().oeGamma(), options.kConvertTf, options.kAssignTf);
                        }
                    }
                }
                else if (!in.formatName().compare("png"))
                {
                    ...
                    warning(
                        "No transfer function can be determined from {}-bit PNG input file \"{}\", "
                        "defaulting to {}. Use --{} to override.",
                        spec.format().channelBitLength(), in.filename(),
                        toString(srcColorSpaceInfo.usedTransferFunction), options.kAssignTf);
                }
            }
        }
    ...
    void CommandCreate::determineTargetColorSpace(const ImageInput &in, ImageSpec &target,
                                                  ColorSpaceInfo &colorSpaceInfo)
    {
        // Primaries handling:
        //
    ...
    void CommandCreate::determineSourceOrigin(const ImageInput &in,
                                              ImageSpec::Origin &usedSourceOrigin)
    {
        if (options.assignTexcoordOrigin.has_value())
        {
                                              ...
                                              ImageSpec::Origin &usedSourceOrigin)
    {
        ...
        if (options.convertTexcoordOrigin.has_value())
        {
            ...
            {
                fatal(rc::INVALID_FILE,
                      "Cannot convert texcoord origin as no information about the origin "
                      "is available in the input file \"{}\". Use --{} to specify one.",
    ...
    void CommandCreate::checkSpecsMatch(const ImageInput &currentFile, const ImageSpec &firstSpec)
    {
        ...
        if (currentFormat.transfer() != firstFormat.transfer())
        {
            ...
            {
                warning(
                    "Input image \"{}\" has different transfer function ({}) than the first image ({})"
                    " but will be treated identically as specified by the --assign-tf option.",
                    currentFile.filename(), toString(currentFormat.transfer()),
                    toString(firstFormat.transfer()));
            }
            else if (options.convertTF.has_value())
            {
                warning(
                    "Input image \"{}\" has different transfer function ({}) than the first image ({})"
                    " and thus will go through different transfer function conversion to the target "
                    "transfer"
        ...
        {
            auto currentGamma =
                currentFormat.oeGamma() != -1 ? std::to_string(currentFormat.oeGamma()) : "no gamma";
            auto firstGamma =
                firstFormat.oeGamma() != -1 ? std::to_string(firstFormat.oeGamma()) : "no gamma";
            if (options.assignTF.has_value())
            {
                warning(
                    "Input image \"{}\" has different gamma ({}) than the first image ({})"
                    " but will be treated identically as specified by the --assign-tf option.",
        ...
        if (currentFormat.primaries() != firstFormat.primaries())
        {
            ...
            {
                warning(
                    "Input image \"{}\" has different primaries ({}) than the first image ({})"
                    " but will be treated identically as specified by the --assign-primaries option.",
                    currentFile.filename(), toString(currentFormat.primaries()),
                    toString(firstFormat.primaries()));
            }
            ...
            else
            {
                fatal(rc::INVALID_FILE,
                      "Input image \"{}\" has different primaries ({}) than the first image ({})."
                      " Use --assign-primaries or --convert-primaries to specify handling and stop "
                      "this error.",
                      currentFile.filename(), toString(currentFormat.primaries()),
                      toString(firstFormat.primaries()));
            }
        ...
        {
            warning("Input image \"{}\" has a different component count than the first image.",
        ...
        if (currentFile.spec().origin() != firstSpec.origin())
        {
            ...
            {
                warning(
                    "Input image \"{}\" has different texcoord origin ({}) than the first image ({})"
                    " but will be treated identically as specified by the --assign-texcoord-origin "
                    "option.",
                    currentFile.filename(), toString(currentFile.spec().origin()),
                    toString(firstSpec.origin()));
            }
            ...
            else
            {
                fatal(rc::INVALID_FILE,
                      "Input image \"{}\" has different texcoord origin ({}) than the first image ({})."
                      " Use --assign-texcoord-origin or --convert-texcoord-origin to specify handling "
                      "and stop this error.",
                      currentFile.filename(), toString(currentFile.spec().origin()),
                      toString(firstSpec.origin()));
            }
